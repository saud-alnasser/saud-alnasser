...
| `tests/` | the Playwright tests over the built site, and the two Node tests `pnpm test:content` runs first: the technology marks' licences and the education timeline's order |
