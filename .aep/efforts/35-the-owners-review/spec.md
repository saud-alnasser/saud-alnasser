...
2. The footer on every page begins "©", the build's year, and the profile's name, and links every profile in `profile.yaml` and the repository. The logo credits disclosure still lists every mark whose licence asks for credit.
